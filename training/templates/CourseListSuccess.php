                ...
                <thead>
                    <tr>
                        ...
                        <td scope="col">
                            ...
                            ?>
                            <?php echo $sorter->sortLink($feildName, __('Training Name'), '@courseList', ESC_RAW); ?>
                        ...
                        <td scope="col">
                            ...
                            ?>
                            <?php echo $sorter->sortLink($feildName, __('Institute'), '@courseList', ESC_RAW); ?>

                        </td>
                        <td><?php echo "Training Code" ?></td>
                        <td scope="col">

                            <?php echo $sorter->sortLink('t.td_course_year', __('Year'), '@courseList', ESC_RAW); ?>
                        ...
                        <td scope="col">
                            ...
                            <?php echo $sorter->sortLink($feildName, __('Venue'), '@courseList', ESC_RAW); ?>
                ...
                <tbody>
                    ...
                    ?>
                                <tr class="<?php echo $cssClass ?>">
                                    <td>
                                        <input type='checkbox' class='checkbox innercheckbox' name='chkLocID[]' id="chkLoc" value='<?php echo $lc->getTd_course_id() ?>' />
                                    </td>

                                    <td class="">
                                        <a href="<?php echo url_for('training/UpdateCourse?id=' . $encrypt->encrypt($lc->getTd_course_id())) ?>">
                                <?php
                                $abc = "getTd_course_name_" . $culture;
                                $dd = $lc->$abc();
                                $rest = substr($lc->$abc(), 0, 100);
                                if ($lc->$abc() == "") {
                                    $dd = $lc->getTd_course_name_en();
                                    $rest = substr($lc->getTd_course_name_en(), 0, 100);
                        ...
                        <td class="">
                            <a href="<?php echo url_for('training/UpdateCourse?id=' . $encrypt->encrypt($lc->getTd_course_id())) ?>">
                                ...
                                $dd = $lc->TrainingInstitute->$abc();
                                $rest = substr($lc->TrainingInstitute->$abc(), 0, 100);
                                if ($lc->TrainingInstitute->$abc() == "") {

                                    $dd = $lc->TrainingInstitute->getTd_inst_name_en();
                                    $rest = substr($lc->TrainingInstitute->getTd_inst_name_en(), 0, 100);
                                    if (strlen($dd) > 100) {
                                        echo $rest ?>.<a href="" title="<?php echo $dd ?>" onclick="javascript:disableAnchor(this, true)">...</a> <?php
                                    } else {
                                        echo $rest;
                        ...
                        <td class="">
                            ...
                            <td class="">
                                ...
                                $rest = substr($lc->$abc(), 0, 100);
                                if ($lc->$abc() == "") {
                                    $dd = $lc->getTd_course_venue_en();
                                    $rest = substr($lc->getTd_course_venue_en(), 0, 100);
