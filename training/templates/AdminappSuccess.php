...
<div class="outerbox">
    <div class="maincontent">
        ...
        <div class="mainHeading"><h2><?php echo __("Pending Admin Approvel List") ?></h2></div>
        <?php echo message() ?>
            ...
            echo 'selected' ?>><?php echo __("Employee Name") ?></option>
                    ...
                    <form name="standardView" id="standardView" method="post" action="<?php echo url_for('training/Adminapp') ?>">
                        ...
                        <table cellpadding="0" cellspacing="0" class="data-table">
                            ...
                            ?>
                            <?php echo $sorter->sortLink($feild, __('Employee Name'), '@pendingT', ESC_RAW); ?>
                            ...
                            ?>
                            <?php echo $sorter->sortLink($feild, __('Institute'), '@pendingT', ESC_RAW); ?>
                            ...
                            ?>
                            <?php echo $sorter->sortLink($feild, __('Training Name'), '@pendingT', ESC_RAW); ?>

                                    </td>
                                    <td scope="col" style="width: 80px;">

                            <?php echo $sorter->sortLink('t.td_asl_year', __('Training Calender year'), '@pendingT', ESC_RAW); ?>

                                    </td>
                                    <td scope="col" style="width: 80px;">

                            <?php echo $sorter->sortLink('t.td_asl_isapproved', __('Approved (Yes/No)'), '@pendingT', ESC_RAW); ?>
                                    </td>
                                    <td scope="col">
                            <?php echo $sorter->sortLink('c.td_course_fromdate', __('Start Date'), '@pendingT', ESC_RAW); ?>

                                    </td>
                                    <td scope="col">
                            <?php echo $sorter->sortLink('c.td_course_todate', __('End Date'), '@pendingT', ESC_RAW); ?>
                    ...
                    <?php
                                        ...
                                        foreach ($trainSummeryList as $trainlist) { 
                                            ...
                                            if($trainlist->app_emp_number == $_SESSION['empNumber'] || $_SESSION['isAdmin'] == "Yes"){
...
?>
                            ...
                            ?>
                                            <select id='parti11_<?php echo $row ?>' name='isappr_<?php echo $trainlist->Employee->getEmp_number() . "_" . $trainlist->TrainingCourse->getTd_course_id() ?>' style='width:50px;'>
                                                <option value="0" <?php if($trainlist->td_asl_isapproved == "0"){ echo "selected"; } ?>><?php echo __('No') ?></option>
                                                <option value="1" <?php if($trainlist->td_asl_isapproved == "1"){ echo "selected";} ?>><?php echo __('Yes') ?></option>
                                                <option value="2" <?php if($trainlist->td_asl_isapproved == "2"){ echo "selected"; } ?>><?php echo __('Reject') ?></option>
                                            </select>
                                        </td>
                                        <td class="">
                            <?php
                    ...
                    url: "<?php echo url_for('training/AjaxEncryption') ?>",
                        ...
                        $(document).ready(function() {
                            ...
                            $("#resetBtn").click(function(){
                                location.href = "<?php echo url_for(public_path('../../symfony/web/index.php/training/Adminapp')) ?>";
        });
