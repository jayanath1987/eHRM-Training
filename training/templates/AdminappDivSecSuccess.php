...
<div class="outerbox">
    <div class="maincontent">
        ...
        <div class="mainHeading"><h2><?php echo __("Secretary Pending Approvel List") ?></h2></div>
        <?php echo message() ?>
            ...
            echo 'selected' ?>><?php echo __("Employee Name") ?></option>
                    ...
                    <form name="standardView" id="standardView" method="post" action="<?php echo url_for('training/Adminapp') ?>">
                        ...
                        <table cellpadding="0" cellspacing="0" class="data-table">
                            ...
                            ?>
                            <?php echo $sorter->sortLink($feild, __('Employee Name'), '@pendingTDivSec', ESC_RAW); ?>
                            ...
                            ?>
                            <?php echo $sorter->sortLink($feild, __('Institute'), '@pendingTDivSec', ESC_RAW); ?>
                            ...
                            ?>
                            <?php echo $sorter->sortLink($feild, __('Training Name'), '@pendingTDivSec', ESC_RAW); ?>

                                    </td>
                                    <td scope="col" style="width: 80px;">

                            <?php echo $sorter->sortLink('t.td_asl_year', __('Training Calender year'), '@pendingTDivSec', ESC_RAW); ?>

                                    </td>
                                    <td scope="col" style="width: 80px;">

                            <?php echo $sorter->sortLink('t.td_asl_isapproved', __('Approved (Yes/No)'), '@pendingTDivSec', ESC_RAW); ?>
                                    </td>
                                    <td scope="col">
                            <?php echo $sorter->sortLink('c.td_course_fromdate', __('Start Date'), '@pendingTDivSec', ESC_RAW); ?>

                                    </td>
                                    <td scope="col">
                            <?php echo $sorter->sortLink('c.td_course_todate', __('End Date'), '@pendingTDivSec', ESC_RAW); ?>
                    ...
                    <?php
                                        ...
                                        foreach ($trainSummeryList as $trainlist) {
                                            if ($trainlist->td_asl_appr_emp_number == $employee || $trainlist->td_asl_appr_sub_emp_number == $employee) {
                    ...
                    url: "<?php echo url_for('training/AjaxEncryption') ?>",
                        ...
                        function save1(id,value,empId,cId,row){
                            ...
                            if(mode=='edit'){
                                ...
                                $.post(
                                "<?php echo url_for('training/SaveAdminAppDivSec') ?>", //Ajax file
                        ...
                        $(document).ready(function() {
                            ...
                            $("#resetBtn").click(function(){
                                location.href = "<?php echo url_for(public_path('../../symfony/web/index.php/training/AdminappDivSec')) ?>";
        });
