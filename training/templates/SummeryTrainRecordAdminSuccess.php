...
<div class="outerbox">
    <div class="maincontent">
        ...
        <div class="mainHeading"><h2><?php echo __("Training record feedback summary") ?></h2></div>
        <?php echo message() ?>
...
<?php } ?>
                         ...
                         <form name="standardView" id="standardView" method="post" action="<?php echo url_for('training/DeleteTrainRecord?userType=' . $userType) ?>">
                            ...
                            ?>
                            <?php echo $sorter->sortLink($feild, __('Employee Name'), '@trainRecordSummeryAdmin', '', 'user=' . $userType, ESC_RAW); ?>
                            ...
                            ?>
                            <?php echo $sorter->sortLink($feild, __('Institute'), '@trainRecordSummeryAdmin', '', 'user=' . $userType, ESC_RAW); ?>
                            ...
                            ?>
                            <?php echo $sorter->sortLink($feild, __('Training Name'), '@trainRecordSummeryAdmin', '', 'user=' . $userType, ESC_RAW); ?>

                                    </td>
                                    <td scope="col">

                            <?php echo $sorter->sortLink('t.td_asl_year', __('Training Calender year'), '@trainRecordSummeryAdmin', '', 'user=' . $userType, ESC_RAW); ?>
                    ...
                    ?>
                                            <tr class="<?php echo $cssClass ?>">
                                                ...
                                                <td >
                                                    <input type='checkbox' class='checkbox innercheckbox' name='chkLocID[]' id="chkLoc" value='<?php echo $trainlist->getTd_course_id() . "_" . $trainlist->Employee->getEmp_number() ?>' />
                                                </td>

                                                <td class="">
                                                    <a href="<?php echo url_for('training/UpdateTrainRecord?empid=' . $encryptObj->encrypt($trainlist->Employee->getEmp_number()) . '&corsid=' . $encryptObj->encrypt($trainlist->getTd_course_id()) . '&mode=edit&userType=Admin') ?>">
