...
<div class="outerbox">
    <div class="maincontent">
        ...
        <div class="mainHeading"><h2><?php echo __("HR Admin Pending Approvel List") ?></h2></div>
        <?php echo message() ?>
        <form name="frmSearchBox" id="frmSearchBox" method="post" action="" onsubmit="return validateform()">
            ...
            echo 'selected' ?>><?php echo __("Employee Name") ?></option>
                    ...
                    <form name="standardView" id="standardView" method="post" action="<?php echo url_for('training/AdminappHRAdmin') ?>">
                        ...
                        <table cellpadding="0" cellspacing="0" class="data-table">
                            ...
                            ?>
                            <?php echo $sorter->sortLink($feild, __('Employee Name'), '@pendingTHRAdmin', ESC_RAW); ?>
                            ...
                            ?>
                            <?php echo $sorter->sortLink($feild, __('Institute'), '@pendingTHRAdmin', ESC_RAW); ?>
                            ...
                            ?>
                            <?php echo $sorter->sortLink($feild, __('Training Name'), '@pendingTHRAdmin', ESC_RAW); ?>

                                    </td>
                                    <td scope="col" style="width: 80px;">

                            <?php echo $sorter->sortLink('t.td_asl_year', __('Training Calender year'), '@pendingTHRAdmin', ESC_RAW); ?>

                                    </td>
                                    <td scope="col" style="width: 80px;">

                            <?php echo $sorter->sortLink('t.td_asl_isapproved', __('Approved (Yes/No/Reject)'), '@pendingTHRAdmin', ESC_RAW); ?>
                                    </td>
                                    <td scope="col">
                            <?php echo $sorter->sortLink('c.td_course_fromdate', __('Start Date'), '@pendingTHRAdmin', ESC_RAW); ?>

                                    </td>
                                    <td scope="col">
                            <?php echo $sorter->sortLink('c.td_course_todate', __('End Date'), '@pendingTHRAdmin', ESC_RAW); ?>
                    ...
                    url: "<?php echo url_for('training/AjaxEncryption') ?>",
                        ...
                        function save1(id,value,empId,cId,row){
                            ...
                            if(mode=='edit'){
                                ...
                                //alert('save');
                                $.post(
                                "<?php echo url_for('training/SaveAdminAppHRAdmin') ?>", //Ajax file
                        ...
                        $(document).ready(function() {
                            ...
                            $("#resetBtn").click(function(){
                                location.href = "<?php echo url_for(public_path('../../symfony/web/index.php/training/AdminappHRAdmin')) ?>";
        });
