...
<div class="outerbox">
    <div class="maincontent">
        ...
        <div class="mainHeading"><h2><?php echo __("Training Participation Summary") ?></h2></div>
        <?php echo message() ?>
            ...
            echo 'selected' ?>><?php echo __("Employee Name") ?></option>
                    ...
                    <div class="actionbar">
                        <div class="actionbuttons">
                            ...
                            <input type="button" class="plainbtn" id="BtnAddparti"
...
<!--                                        <input type="checkbox" class="checkbox" name="allCheck" value="" id="allCheck" />-->
                            ...
                            ?>
                            <?php echo $sorter->sortLink($feild, __('Employee Name'), '@trainPartisummry', ESC_RAW); ?>
                            ...
                            ?>
                            <?php echo $sorter->sortLink($feild, __('Institute'), '@trainPartisummry', ESC_RAW); ?>
                            ...
                            ?>
                            <?php echo $sorter->sortLink($feild, __('Training Name'), '@trainPartisummry', ESC_RAW); ?>

                                    </td>
                                    <td scope="col">

                            <?php echo $sorter->sortLink('t.td_asl_year', __('Training Calender year'), '@trainPartisummry', ESC_RAW); ?>

                                    </td>
                                    <td scope="col">
                            <?php echo $sorter->sortLink('t.td_asl_isapproved', __('Participated (Yes/No)'), '@trainPartisummry', ESC_RAW); ?>

                                    </td>
                                    <td scope="col">
                            <?php echo $sorter->sortLink('c.td_course_fromdate', __('Start Date'), '@trainPartisummry', ESC_RAW); ?>

                                    </td>
                                    <td scope="col">
                            <?php echo $sorter->sortLink('c.td_course_todate', __('End Date'), '@trainPartisummry', ESC_RAW); ?>
...
?>
                            ...
                            <?php
                                            if ($trainlist->getTd_asl_isattend() == 0)
                                                echo __("No"); else
                                                echo __("Yes");
                            ?>
                                        </td>
                    ...
                    url: "<?php echo url_for('training/AjaxEncryption') ?>",
                        ...
                        $(document).ready(function() {
                            ...
                            $("#resetBtn").click(function() {
                                location.href = "<?php echo url_for(public_path('../../symfony/web/index.php/training/participateSummery')) ?>";
        ...
        //When click Save Button
        $("#BtnAddparti").click(function() {
            location.href = "<?php echo url_for(public_path('../../symfony/web/index.php/training/participations')) ?>";
